...
<body background="Images/MyBackground.png" bgcolor="#FFCC99">
    ...
    <?php
        include ("connect.php");
        $i = mysqli_query("update tbl_student set name='".$_POST['txtname']."', gender='".$_POST['txtgender']."', dob='".$_POST['txtdob']."', address='".trim($_POST['txtaddress'])."', sub='".$_POST['txtsubject']."', date='".$_POST['txtdate']."' where stuid=".$_POST['txtid']);
        if($i==true){
