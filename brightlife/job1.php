    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="#"><span><i class="fas fa-address-card"></i>About Us</span></a></li>
          <li class=""><a href=""><span><i class="fas fa-briefcase"></i> jobs</span></a></li>
          <li><a href=""><span><i class="fas fa-phone"></i>Contact Us</span></a></li>
          <li><a href="./index.php"><span><i class="fas fa-sign-in-alt"></i>Logout</span></a></li>
          <li><a href=""><span><i class="fas fa-user-plus"></i>Sign-up</span></a></li>  
        </ul>
      </div>
      <div class="logo">
...
?>
              ...
              <div class="mainsub">
                ...
                <div class="m3"> <?php echo '<a href="jobdes1.php?id='. $res['id'].' &email='.$regValue.'" >View Job</a>';?>
