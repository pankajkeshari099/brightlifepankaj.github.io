...
if(isset($_POST['but_submit'])){
    ...
    if ($id != "" && $password != ""){
        ...
        $sql_query = "select count(*) as cntUser from seeker where email='".$id."' and pass='".$password."'";
...
width:550px;
height:350px;
background:linear-gradient(155deg,#03B9D5,#C607CF);
margin-top: 70px;
margin-left: 25px;
padding-top: 10px;
border-radius: 15px;
...
border-radius: 15px;
padding-right: 30px;
background:linear-gradient(135deg,#9b59b9,#71b7e6);
}
.lnk3
{
  width:100px;
...
{
  width: 26em;
background:linear-gradient(135deg,#1D36D3,#1ACB2C);
font-size:20px;
cursor: pointer;
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
       ...
       <form action="http://localhost/brightlife/job1.php" method="get">
	 <div class="mainbtn">
	 <div class="btn101"><a href="#" class="lnk1">&nbsp&nbsp&nbsp Job Seeker Login</a></div>
   <div class="btn301"><a href="#"><h3> Log in with Email ID</h3></a>
   <input type="text" name="txt_id"placeholder="Enter your email-id" required><br>
   <input type="password" name="txt_pwd"placeholder="Enter Password" required><br>
