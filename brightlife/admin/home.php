...
width:550px;
height:280px;
background:linear-gradient(135deg,#C06166,#29A934);
margin-top: 20px;
margin-left: 25px;
padding-top: 10px;
border-radius: 10px;
...
position:relative;
right: 116px;
background:linear-gradient(135deg,#5ED3CB,#232799);
border-radius:10px;
border:1px solid black;
...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        ...
        <li class="active"><a href="index.html"><span><i class="fas fa-home"></i>Home Page</span></a></li>
          ...
          <li class="active"><a href="index.php"></i><span><i class="fas fa-sign-in-alt"></i>LOGOUT</span></a></li>
          <li><a href="signup.php"></i><span><i class="fas fa-user-plus"></i>SIGN-UP</span></a></li>  
           </ul>    
	</div>
      <div class="logo">
        <h1 id="heaging"><a href="index.html">BRIGHT<span>LIFE</span> <small>DREAMS COMES TRUE </small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
	 ...
	 <div class="mainbtn"> <h2>CHOOSE TO LOGIN</h2>
	 <div class="btn301"><a href="#" class="lnk3" id="a5">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWhat is your role? 
  <div class="j1"><a href="./jobseeker_details/display.php">Job Seeker</a></div>
   <div class="e1"><a href="./employer_details/display.php">Employer</a></div>
